...
| Speaker diarization | [Streaming Sortformer 4-speaker V2](https://huggingface.co/nvidia/diar_streaming_sortformer_4spk-v2) and high-resolution 8-speaker V3, standalone or combined with ASR |
