...
`ami_en2002d_2172.wav` is 20 s of meeting EN2002d (Mix-Headset, from 2172.5 s)
...
unmodified 16 kHz mono PCM. Three speakers take turns, with brief overlap.

`ami_en2002d_2172.rttm` is the matching reference, cut from the word-aligned
...
`ami_en2002d_2172.json` is the reference transcript by speaker, taken from the
